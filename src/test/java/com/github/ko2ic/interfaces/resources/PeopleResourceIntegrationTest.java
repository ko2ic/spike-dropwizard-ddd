...
import com.github.ko2ic.infrastructure.SampleDDDApplication;
import com.github.ko2ic.infrastructure.SampleDDDConfiguration;
...
public class PeopleResourceIntegrationTest {
	...
	@ClassRule
	public static final DropwizardAppRule<SampleDDDConfiguration> RULE = new DropwizardAppRule<>(
			SampleDDDApplication.class, "example.yml");
